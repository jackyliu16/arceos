//! A intrusive LinkedList Copy From arceos/buddy_system_allocator
//! Provide more method 
...
impl LinkedList {
    ...
    pub unsafe fn push(&mut self, item: *mut usize) {
        axlog::debug!("push {:x} into LinkedList", item as usize);
        axlog::debug!("current head: {:x}", self.head as usize);
        axlog::debug!("current ptr: {:p}",  core::ptr::addr_of!(self));
